package com.mytests.stream.portfolio;
...
public class BoardTestSuite {
    ...
    public Board prepareTestData() {
        ...
        //tasks
        Task task1 = new Task("Microservice for taking temperature", "Write and test the microservice taking the temperaure from external service", user1, user2, LocalDate.now().minusDays(20), LocalDate.now().plusDays(30));
    ...
    public void testAddTaskListFindOutdatedTasks() {
        ...
        undone.add(new TaskList("To do"));
        undone.add(new TaskList("In progress"));
        List<Task> tasks = project.getTaskLists().stream()
                .filter(undone::contains)
                .flatMap(l -> l.getTasks().stream())
    ...
    public void testAddTaskListFindLongTasks() {
        ...
        long resultTasks = project.getTaskLists().stream()
        ...
        //Then
        Assert.assertEquals(2, resultTasks);
    }
}
